...
public class CodeMsg {
    ...
    // 登录模块 5002xx
    private static CodeMsg SESSION_ERROR = new CodeMsg(500100,"Session不存在或者已经失效");
    public static CodeMsg PASSWORD_EMPTY = new CodeMsg(500211,"密码不能为空");
    public static CodeMsg MOBILE_EMPTY = new CodeMsg(500212,"手机号不能为空");
    public static CodeMsg MOBILE_ERROR = new CodeMsg(500213,"手机号码格式错误");
    public static CodeMsg MOBILE_NOT_EXISTS = new CodeMsg(500214,"手机号码不存在");
    ...
    public static CodeMsg REPEATE_SECKILL = new CodeMsg(500500,"不能重复秒杀");
